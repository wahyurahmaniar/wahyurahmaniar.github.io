// ─────────────────────────────────────────────────────
// NEWS & TOPICS — edit this file to add/update news
// Each item: {b: badge-class, l: label, t: title, d: date}
// Badge classes: nb-p (paper) nb-t (talk/keynote) nb-a (award/grant) nb-n (open source) nb-w (workshop/media)
// ─────────────────────────────────────────────────────
var NA=[
  ...
  {b:'nb-n',l:'Open Source',t:'MedSeg Framework v2.0 released — 15+ pretrained models, MONAI integration',d:'October 2024'},
